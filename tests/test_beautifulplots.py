...
def test_plot_defaults(asserts=True, verbose=False):
    """Test plot defaults."""

    plot_defaults_expected = {
        "pltstyle": "ggplot",
        "figsize": None,
        "w_space": 0.2,
        "h_space": 0.2,
    ...
    if verbose:
        for k in plot_defaults_actual:
            print(k)
            print(
                f"expected: {k}:{plot_defaults_expected[k]},  actual {k}:{plot_defaults_actual[k]}"
            )
...
def test_barplot():
    ...
    barplot_data = {
        ...
        "sales": [90, 60, 50, 50, 30, 20, 40, 40, 20],
    ...
    plot_return = bp.barplot(
        df,
        "category",
        "sales",
        hue="store",
        palette="tab20",
        title="1e. easy barplot, Product Category Sales by Store, horizontal bars",
        figsize=(12, 8),
        bardatalabels=True,
        bardataformat=".2f",
        barcurrency=True,
    ...
    bp.barplot(
        ...
        "sales",
        palette="tab20",
        title="1a. Beautifulplots barplot, Sales All Stores by Product Category, secondary y-axis",
        figsize=(12, 4),
        bardatalabels=True,
        bardataformat=".2f",
        barcurrency=True,
